...
- files have *format:* 
  ...
  f. plays a similar rolet to variable types: 
  
  f. guides interpretation, memorization and exchange

However, in principle Python can open and read any file, 

f. (even AV ones) are seen as a mere succession of characters, terminated by the special character EOF 
