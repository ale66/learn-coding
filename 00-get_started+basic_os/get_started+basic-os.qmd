...
*It's nice and clear, and 25 degrees in Naples today. _No, it's 77 in Naples (FL)_* 
...
- hierarchy is not about importance, it's about creating *locality*
...
*the absolute path:* ``C:\Users\ale\_git\learn-coding\00-get_started+basic_os\converter.py``

*another abs. path:* ``C:\Users\ale\Downloads\converter.py``
...
```bash
>pwd
/home/ale/_git/learn-coding/02-get_started+syntax
>python ../00-get_started+basic_os/example-temperature-converter/my_converter.py
```
...
```bash
>cd
C:\Users\aless\Downloads\_git\learn-coding\02-get_started+syntax
>python ..\00-get_started+basic_os\example-temperature-converter\my_converter.py
```
...
Start the Terminal app from the tray
