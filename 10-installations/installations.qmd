...
- online code execution with visualisation
...
For reference: *Foundations of Python Programming,* a version of __Think Python__, from 
...
For Win 11: you may need to authorise installations. 

For MacOS: proceed to normal app download+installation. 
...
fetch+install *packages* containing needed Py. functions

Now it's part of the distribution, read below for reference
...
## Incremental/differential synchronisation
